namespace LogFileEater
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.cbxAddNewLine = new System.Windows.Forms.CheckBox();
			...
			// cbxAddNewLine
			// 
			this.cbxAddNewLine.AutoSize = true;
			this.cbxAddNewLine.Checked = true;
			this.cbxAddNewLine.CheckState = System.Windows.Forms.CheckState.Checked;
			this.cbxAddNewLine.Location = new System.Drawing.Point(7, 448);
			this.cbxAddNewLine.Name = "cbxAddNewLine";
			this.cbxAddNewLine.Size = new System.Drawing.Size(84, 17);
			this.cbxAddNewLine.TabIndex = 3;
			this.cbxAddNewLine.Text = "Add newline";
			this.cbxAddNewLine.UseVisualStyleBackColor = true;
			// 
			// btnAddLabel
			// 
			this.btnAddLabel.Location = new System.Drawing.Point(7, 419);
			...
			this.Controls.Add(this.cbxAddNewLine);
        ...
        private System.Windows.Forms.CheckBox cbxAddNewLine;
